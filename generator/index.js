"use strict";
const { quicktype, InputData, jsonInputForTargetLanguage, JSONSchemaInput, JSONSchemaStore, } = require("quicktype-core");
...
async function main() {
    const json = `
  {
    ...
    const { lines: pythonPerson } = await quicktypeJSONSchema("typescript", "AuditLogWrittenEvent", json
    // path too
    );
