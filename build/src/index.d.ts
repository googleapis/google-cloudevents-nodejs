import { google, GoogleCloudEvent, GoogleCloudEventsUnion, GoogleCloudEventTypesToDataType } from '../events/events';
/**
 ...
 */
export declare function isGoogleEvent(event: any): event is GoogleCloudEventsUnion;
/**
 ...
 * @returns true if this event is a GoogleCloudEvent of the provided type, false otherwise
 */
export declare function isGoogleEvent<T extends keyof GoogleCloudEventTypesToDataType>(event: any, eventType: T): event is GoogleCloudEvent<T>;
