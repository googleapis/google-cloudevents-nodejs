...
const obj0: google.events.cloud.audit.v1.LogEntryData = {
  ...
  protoPayload: {
    ...
    resourceName:
      'projects/test-project/jobs/bqjob_r3ac45813612fa2d6_0000017d591922c9_1',
    serviceData: {
...
const obj9: google.events.cloud.storage.v1.StorageObjectData = {
  ...
  mediaLink:
    'https://www.googleapis.com/download/storage/v1/b/projectid-sample-bucket/o/MyFile?generation=1588778055917163&alt=media',
  metadata: {},
  metageneration: 1,
  name: 'MyFile',
  retentionExpirationTime: '1960-08-15T07:40:17.432Z',
  selfLink:
    'https://www.googleapis.com/storage/v1/b/projectid-sample-bucket/o/MyFile',
  size: 0,
